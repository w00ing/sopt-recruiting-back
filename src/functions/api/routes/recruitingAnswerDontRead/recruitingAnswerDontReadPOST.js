...
module.exports = async (req, res) => {
  const { recruitingApplicantId, recruitingAdminRoleIds } = req.body;
  ...
  try {
    ...
    const dontRead = await recruitingAnswerDontReadSQL.addRecruitingAnswerDontRead(client, recruitingApplicantId, recruitingAdminRoleIds);
